...
- MVP 6/7 — Lip sync dinâmico fonema/visema: PIPELINE TÉCNICO IMPLEMENTADO E VALIDADO EM TESTE CONTROLADO NO WINDOWS (`npm run test:lipsync`) com Fish Audio SSE timestamps, motor PT-BR com 9 visemas, composição sem dupla boca no navegador a 60 fps, e 158/158 testes passando. Validação em LIVE real com espectador confirmando no celular: PENDENTE.
