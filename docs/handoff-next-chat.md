...
4. adicionar a URL local como fonte de link no TikTok LIVE Studio; se a fonte de link não estiver disponível, capturar a janela do navegador;
5. incluir o áudio do sistema e confirmar movimento no medidor quando o TTS falar;
6. iniciar a LIVE;
7. em outro celular/conta, enviar duas perguntas começando com `ia`;
8. confirmar imagem, voz, `thinking → speaking → idle` e continuidade dos eventos.
